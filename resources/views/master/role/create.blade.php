    ...
    <div class="max-w-4xl mx-auto mt-8 px-4 sm:px-6 lg:px-8">
        <div class="w-full bg-white rounded-3xl shadow-xl p-8 space-y-6">
            ...
            <div class="text-center">
                ...
                <h2 class="mt-3 text-2xl font-bold text-gray-800">Create Role</h2>
                <p class="text-sm text-gray-500">Fill in the details to create a new role</p>
            </div>
            ...
            <!-- Form -->
            <form action="{{ route('role-store') }}" method="POST" class="space-y-4" aria-label="Create role form">
                @csrf
