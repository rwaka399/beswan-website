...
@section('title', 'Tambah Log Keuangan')

@section('content')
    <div class="mt-4 max-w-4xl mx-auto">
        <!-- Header -->
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Tambah Log Keuangan</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="financial_type" id="financial_type"
                            ...
                            <option value="income" {{ old('financial_type') == 'income' ? 'selected' : '' }}>Pemasukan</option>
                            <option value="expense" {{ old('financial_type') == 'expense' ? 'selected' : '' }}>Pengeluaran</option>
                        </select>
